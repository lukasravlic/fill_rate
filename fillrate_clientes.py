...
hoy_mes = datetime.datetime.today().month
hoy_año = datetime.datetime.today().year
meses = {
    '01': "Enero",
    '02': "Febrero",
    '03': "Marzo",
...
base = pd.read_excel(f"C:/Users/{usuario}/Inchcape/Planificación y Compras Chile - Documentos/Planificación y Compras Maestros/Base Planificable/{str(hoy_año)}-{str(hoy_mes).zfill(2)} Base Planificable/Base {meses.get(str(hoy_mes).zfill(2))} OEM-AXS v1.xlsx", header=1, engine='openpyxl', sheet_name='Base')
...
path = f"C:/Users/{usuario}/Inchcape/Planificación y Compras Chile - Documentos/Bases Indicadores en CSV 2025-04/Segmentacion WebApp"
dfs = []
...
segmentacion.to_csv(f"C:/Users/{usuario}/Inchcape/Planificación y Compras Chile - Documentos/Bases Indicadores en CSV 2025-04/segmentacion_consolidado.csv")
...
flag_ipl = pd.read_excel(f"C:/Users/{usuario}/Inchcape/Planificación y Compras Chile - Documentos/Planificación y Compras Maestros/2025/2025-03/2025-03 Base Flag IPL OEM.xlsx", header=0, sheet_name='Base Flag IPL OEM CL',dtype={'Flag IPL': 'str'})
estrategico = pd.read_excel(f"C:/Users/{usuario}/Inchcape/Planificación y Compras Chile - Documentos/Planificación y Compras Maestros/2025/2025-02/Estratégicos Chile - Cierre Enero 2025.xlsx", sheet_name='Estratégico')
...
df_nnss.to_csv(f"C:/Users/{usuario}/Inchcape/Planificación y Compras Chile - Documentos/Planificación y Compras KPI-Reportes/Nivel de Servicio OEM/automatizacion/bases_semanales/derco.csv")
...
inchcape.rename(columns= {'Ce.':'Centro','ClVt':'Clase doc.ventas','Pedido':'Documento de ventas','Denominación':'Descripción del material','Ctd.ped..1':'Cantidad de pedido (Posición)','Marca':'Nombre sector','Líneas OK':'Línea OK', 'Líneas VOR':'Línea VOR', 'Líneas Totales':'Línea Totales','Qty OK':'Qty Venta' ,'Qty Totales':'Qty Total','Fecha doc-':'Fecha documento', 'Inventario':'Planificables', 'Material': 'UE R3'}, inplace=True)
